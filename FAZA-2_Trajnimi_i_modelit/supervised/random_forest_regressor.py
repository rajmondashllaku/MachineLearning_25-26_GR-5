...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'rf_feature_importance1.png'), dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'rf_actual_vs_predicted1.png'), dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'rf_residuals1.png'), dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, 'rf_model_comparison1.png'), dpi=150)
plt.close()
