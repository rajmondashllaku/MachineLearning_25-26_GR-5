...
class AirQualityLinearPhase3:
    ...
    def create_consistent_plots(self, output_dir='images'):
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, 'faza3_actual_vs_predicted.png'), dpi=150)
        plt.close()
        ...
        for i, (name, res) in enumerate(self.results.items()):
            ...
            ax.set_title(f'FAZA 3 Residuals - {name}\n(Mean={residuals.mean():.3f}, Std={residuals.std():.3f})', 
                         fontweight='bold')
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, 'faza3_residuals.png'), dpi=150)
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, 'faza3_model_comparison.png'), dpi=150)
        plt.close()
